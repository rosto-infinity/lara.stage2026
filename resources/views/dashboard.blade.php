    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 bg-white border border-gray-200 rounded-md p-5">
            ...
            <div class="grid grid-cols-2 gap-2">
                @foreach([
                    ['url' => '/academic/programs',       'label' => 'Filières'],
                    ['url' => '/academic/specialties',    'label' => 'Spécialités'],
                    ['url' => '/academic/levels',         'label' => 'Niveaux'],
                    ['url' => '/academic/semesters',      'label' => 'Semestres'],
                    ['url' => '/academic/course-units',   'label' => 'Unités d\'Enseignement'],
                    ['url' => '/academic/academic-years', 'label' => 'Années Académiques'],
                ] as $link)
                <a href="{{ $link['url'] }}"
